...
//    screen.renderer.setClearColor( new THREE.Color( "black" ) );
    ...
    var folder = gui.addFolder('BlinnPhongReflection');
    folder.add(guiObj, 'ka', 0, 1).onChange(setShaderMaterial);
    folder.add(guiObj, 'kd', 0, 1).onChange(setShaderMaterial);
    folder.add(guiObj, 'ks', 0, 1).onChange(setShaderMaterial);
    folder.add(guiObj, 'n', 0, 100).onChange(setShaderMaterial);
    folder.open();
